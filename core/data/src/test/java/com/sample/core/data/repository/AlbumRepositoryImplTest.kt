...
class AlbumRepositoryImplTest {
    ...
    @Test
    fun `getAlbums returns mapped albums from network`() =
        runTest {
    ...
    @Test
    fun `getAlbumById fetches albums when cache is empty`() =
        runTest {
            coEvery { networkRequests.getItunesRss() } returns rssResponse()
    ...
    @Test
    fun `getAlbumById uses cache when album is already loaded`() =
        runTest {
            coEvery { networkRequests.getItunesRss() } returns rssResponse()
    ...
    @Test
    fun `getAlbumById returns null when album does not exist`() =
        runTest {
            coEvery { networkRequests.getItunesRss() } returns rssResponse()
